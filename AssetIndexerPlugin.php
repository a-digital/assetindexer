...
class AssetIndexerPlugin extends BasePlugin
{
    ...
    {
        return Craft::t('Index a very large assets folder in batches when Craft fails to do so');
    }
    ...
    {
        return array(
	        'assetindexer/begin/(?P<source>.+)/(?P<step>\d+)' => 'assetindexer/begin',
            'assetindexer/begin/(?P<source>.+)' => 'assetindexer/begin',
            'assetindexer/step/(?P<source>.+)/(?P<step>\d+)' => 'assetindexer/step',
            'assetindexer/step/(?P<source>.+)' => 'assetindexer/step',
            'assetindexer/fileindex/(?P<source>.+)/(?P<step>\d+)' => 'assetindexer/fileindex',
            'assetindexer/fileindex/(?P<source>.+)' => 'assetindexer/fileindex',
            'assetindexer/file/(?P<source>.+)/(?P<step>\d+)' => 'assetindexer/file',
            'assetindexer/file/(?P<source>.+)' => 'assetindexer/file',
       );
    }
}